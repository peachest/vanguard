...
import {DynamicBorderColorIcon} from "src/components/atoms/icons/color/dynamic-border-color";

const component = DynamicBorderColorIcon as FC ;
const title = "Atoms/Icons/DynamicColors/DynamicBorderColorIcon" ;
