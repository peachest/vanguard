...
import {DynamicFormatColorFillIcon} from "src/components/atoms/icons/color/dynamic-format-color-fill";

const component = DynamicFormatColorFillIcon as FC ;
const title = "Atoms/Icons/DynamicColors/DynamicFormatColorFillIcon" ;
